...
import {
  ...
  getTBCCContract,
  getNftTDAContract,
  getGameContract, getNftVODAContract
...
export const useB8D = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getB8DContract(library.getSigner()), [library])
}
...
export const useICOContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getICOContract(library.getSigner()), [library])
}
...
export const useNftVODAContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getNftVODAContract(library.getSigner()), [library])
}

export const useTBCC = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getTBCCContract(library.getSigner()), [library])
}
